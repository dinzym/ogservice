...
<head>
    ...
    <link href="{{asset('dashb/vendor/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet">
...
<!-- Page level plugins -->
<script src="{{asset('dashb/vendor/chart.js/Chart.min.js')}}"></script>

<!-- Page level custom scripts -->
<script src="{{asset('dashb/js/demo/chart-area-demo.js')}}"></script>
<script src="{{asset('dashb/js/demo/chart-pie-demo.js')}}"></script>
