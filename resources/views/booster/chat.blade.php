...
<header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href="{{route('booster.dashboard')}}" style="text-decoration: none">Online Service Gaming </a></h1>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a href="#" style="text-decoration: none"><span>{{Auth::guard('booster')->user()->name}}</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
...
<section id="breadcrumbs" class="breadcrumbs">
    <div class="container mt-4">
        ...
        <ol>
            <li><a href="{{route('booster.dashboard')}}" style="text-decoration: none;" >Home</a></li>
            <li>Chat Room</li>
        </ol>
        <h2>Chat</h2>
...
<div class="chat">
    ...
    <!-- Chat -->
    <div class="messages">
        @include('booster.receive', ['message' => "...."])
    </div>
    <!-- End Chat -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Useful Links</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{url('booster/dashboard#hero')}}">Home</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{url('booster/dashboard#about')}}">About us</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{url('booster/dashboard#services')}}">Services</a></li>
                    </ul>
                </div>
