            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('booster.update', $booster->id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="form-group last mb-4">
                                <label for="username" >Username</label>
                                <input type="text" class="form-control" name="name"  value="{{$booster->name}}" >

                            </div>

                            <div class="form-group last mb-4">
                                <label for="password">Email</label>
                                <input type="email" class="form-control" name="email" value="{{$booster->email}}" >
