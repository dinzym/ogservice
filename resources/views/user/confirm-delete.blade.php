            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('customer.delete', $user->id) }}" method="POST">
                            @csrf
                            ...
                            <br>
                            <p class="text-xl-center" >Are you sure you want to delete this user?</p>
                            <div class="container my-3 bg-light">
                                <div class="col-md-12 text-center">
                            <button type="submit" class="btn btn-danger" >Delete</button>
                            <a href="{{ route('admin.customer') }}" style="text-decoration: none">&nbsp;&nbsp;&nbsp;&nbsp;No</a>
                                </div>
                            </div>
                        </form>
